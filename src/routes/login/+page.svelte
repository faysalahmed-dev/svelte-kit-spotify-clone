...
<Button
	size="xs"
	class="bg-emerald-500 hover:bg-emerald-600 text-white mt-6 ml-6"
	on:click={() => goto('/')}
>
	<svg
...
<section class="flex justify-center items-center flex-col min-h-[80vh]">
	<h3 class="font-semibold mb-3 capitalize">To Use This app first need to login with spotify</h3>
